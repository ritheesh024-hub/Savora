    ...
    <div className="min-h-screen bg-[#F8F9FA] dark:bg-zinc-950">
      ...
      <main className="container mx-auto px-4 pt-24 pb-12">
        <div className="max-w-2xl mx-auto space-y-8">
          <div className="bg-orange-gradient p-10 rounded-[3rem] text-white shadow-3xl relative overflow-hidden">
             <div className="absolute top-0 right-0 p-10 opacity-10"><Wallet className="w-40 h-40" /></div>
             <div className="relative z-10 space-y-6">
                ...
                <div>
                   ...
                   <h1 className="text-6xl font-black font-headline italic">{coins} Coins</h1>
                </div>
          ...
          <div className="grid grid-cols-2 gap-4">
             <Card className="rounded-[2.5rem] border-none shadow-xl bg-white dark:bg-zinc-900 p-6 flex flex-col items-center text-center gap-4">
                <div className="w-12 h-12 bg-primary/10 rounded-2xl flex items-center justify-center text-primary"><Gift className="w-6 h-6" /></div>
                <div>
                   <h4 className="font-black text-sm uppercase">Redeem Coins</h4>
                   <p className="text-[10px] text-muted-foreground mt-1">Convert coins into instant discounts.</p>
                </div>
             ...
             <Card className="rounded-[2.5rem] border-none shadow-xl bg-white dark:bg-zinc-900 p-6 flex flex-col items-center text-center gap-4">
                <div className="w-12 h-12 bg-blue-100 rounded-2xl flex items-center justify-center text-blue-600"><History className="w-6 h-6" /></div>
                <div>
                   <h4 className="font-black text-sm uppercase">Coin History</h4>
                   <p className="text-[10px] text-muted-foreground mt-1">View your earning and spending history.</p>
                </div>
          ...
          <div className="space-y-4">
             <h3 className="font-black uppercase tracking-widest text-xs ml-4">How it works</h3>
             {[
               ...
               <div key={i} className="flex gap-4 p-5 bg-white dark:bg-zinc-900 rounded-3xl shadow-sm border border-border/50">
